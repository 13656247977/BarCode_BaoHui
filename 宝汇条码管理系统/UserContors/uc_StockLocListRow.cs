...
namespace 宝汇条码管理系统.UserContors
{
    ...
    {
        public uc_StockLocListRow() : base()
        {
        ...
        {
            this.Form.Session.Add("stockLocId", tx_stockLocId.BindDataValue);
            this.Form.Session.Add("stockLocName", tx_stockLocId.BindDisplayValue);
